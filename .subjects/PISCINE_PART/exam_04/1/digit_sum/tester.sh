...
bash .system/auto_correc_program.sh $FILE $ASSIGN "999"
if [ -e .system/grading/traceback ];then
    mv .system/grading/traceback .
	exit 1
fi
...
bash .system/auto_correc_program.sh $FILE $ASSIGN "241"
if [ -e .system/grading/traceback ];then
    mv .system/grading/traceback .
	exit 1
fi

bash .system/auto_correc_program.sh $FILE $ASSIGN "12" "34" "56"
if [ -e .system/grading/traceback ];then
    mv .system/grading/traceback .
	exit 1
fi
